...
export default function Contact() {
    ...
    return (
        <div className="flex justify-evenly items-center mt-36 ">
            <div className="flex flex-cols border-blue-500 border-2 shadown">
                <div className="pl-6 pr-6 pt-6">
                    <p className="h-16 w-96 text-center">{t("contact.t24")}</p>
                    <div className="flex justify-center items-end h-16">
                        <a
                            className="border-2 border-blue-500 rounded-md hover:bg-blue-400 hover:text-white py-2 px-2 "
